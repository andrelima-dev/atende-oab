      ...
      <header className="border-b border-slate-200 bg-white shadow-sm">
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-center items-center gap-4">
            ...
            />
            <div>
              <h1 className="text-xl font-bold text-slate-800">Sistema de Avaliação</h1>
              <p className="text-sm text-slate-500">OAB/MA - Seccional Maranhão</p>
            </div>
          </div>
        </div>
      </header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="oab" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                      <UserIcon className="w-4 h-4" /> Número da OAB *
                    </label>
